...
truffle.js.JSSprite=function(pos, tex, midbot, viz) 
{	
...
truffle.js.JSSprite.prototype.GetID=function()
{
    return this.ID;
}

truffle.js.JSSprite.prototype.SetID=function(s)
{
    this.ID=s;
}

truffle.js.JSSprite.prototype.Hide=function(s)
{
    this.DrawMe=true;
    this.Hidden=s;
}

truffle.js.JSSprite.prototype.MouseDown=function(c, f)
{
...
truffle.js.JSSprite.prototype.MouseUp=function(c, f)
{
    this.EnableMouse(true);
    this.MouseUpFunc=f;
...
truffle.js.JSSprite.prototype.MouseOver=function(c, f)
{
    this.EnableMouse(true);
...
truffle.js.JSSprite.prototype.MouseOut=function(c, f)
{
    this.EnableMouse(true);
    this.MouseOutFunc=f;
...
truffle.js.JSSprite.prototype.SetDepth=function(s)
{
//    parent.setChildIndex(this,s);
    this.Depth=s;
}
    
truffle.js.JSSprite.prototype.GetDepth=function() 
{
    return this.Depth;
}

truffle.js.JSSprite.prototype.CentreMiddleBottom=function(s)
{
    this.DoCentreMiddleBottom=s;
}

truffle.js.JSSprite.prototype.SetSize=function(x,y)
{
    this.Width=x;
    this.Height=y;
...
truffle.js.JSSprite.prototype.EnableMouse=function(s)
{
    this.MouseEnabled=s;
}

truffle.js.JSSprite.prototype.IsMouseEnabled=function()
{
    return this;
}

truffle.js.JSSprite.prototype.ChangeBitmap=function(t)
{
    if (this.Image==null || 
...
truffle.js.JSSprite.prototype.LoadFromURL=function(url)
{
    var c=this;
...
truffle.js.JSSprite.prototype.SetPos=function(s) { this.Pos=s; this.DrawMe=true; }
truffle.js.JSSprite.prototype.SetScale=function(s) { this.MyScale=s; this.DoTransform=true; this.DrawMe=true; }
truffle.js.JSSprite.prototype.SetRotate=function(angle) { this.Angle=angle; this.DoTransform=true; this.DrawMe=true; }
truffle.js.JSSprite.prototype.GetTx=function() { return this.Transform; }

truffle.js.JSSprite.prototype.SetColour=function(s) 
{
    this.Colour=s;
}

truffle.js.JSSprite.prototype.SetOffsetColour=function(s) 
{
    this.OffsetColour=s;
    if (this.ReadyToDraw)
    {
...
truffle.js.JSSprite.prototype.GetColour=function() 
{
    return this.Colour;
}

truffle.js.JSSprite.prototype.GetOffsetColour=function() 
{
    return this.OffsetColour;
}

truffle.js.JSSprite.prototype.TransformedPos=function()
{
    var p = new Point(0,0);
...
truffle.js.JSSprite.prototype.AddTint=function(col)
{
    return;
...
truffle.js.JSSprite.prototype.GetLastBBox=function()
{
...
truffle.js.JSSprite.prototype.GetBBox=function()
{
...
truffle.js.JSSprite.prototype.Intersect=function(ob)
{
    var tb=this.GetBBox();
...
truffle.js.JSSprite.prototype.UpdateMouse=function(CanvasState)
{
...
truffle.js.JSSprite.prototype.Update=function(frame, tx)
{
    this.DrawMe=true;
...
truffle.js.JSSprite.prototype.Draw=function()
{
...
truffle.js.JSCanvasState=function() 
{
...
truffle.js.JSCanvasState.prototype.BeginScene=function()
{
...
truffle.js.JSCanvasState.prototype.EndScene=function()
{
    this.Ctx.restore();
}

truffle.js.JSCanvasState.prototype.ClearRects=function(BBoxes)
{
    var Skip=false;
    for (i in BBoxes) if (BBoxes[i]==null) Skip=true;
...
truffle.js.JSCanvasState.prototype.SetClip=function(BBoxes)
{
    this.Ctx.save();
...
truffle.js.JSCanvasState.prototype.UnClip=function()
{
    this.Ctx.restore();
}

truffle.js.JSCanvasState.prototype.Update=function()
{
    this.MouseChanged=false;
}
...
truffle.js.JSCanvasState.prototype.UpdateMouse = function(e) 
{
...
truffle.js.JSCanvasState.prototype.Stats=function(num)
{
    this.Ctx.fillStyle="#000000";
