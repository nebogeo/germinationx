...
class SkeletonEntity extends truffle.Entity
{
	...
	public function new(world,pos:Vec3) 
	{
		super(world,pos);
        Root = null;
    ...
    public function Build(world,desc:Array<Dynamic>)
    {
        for (b in bones)
        {
        ...
        {
            bones[b].Pos=relative[b].Mul(1.0); // 0.5
...
//        Root.SetDepth(order++);
	...
	override public function Update(frame:Int, world)
	{
