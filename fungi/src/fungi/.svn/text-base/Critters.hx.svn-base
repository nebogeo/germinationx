...
class Butterfly extends SkeletonEntity
{
    ...
    public function new(world:FungiWorld,pos:Vec3,seed:Int)
    {
	    super(world,pos);
        NeedsUpdate=true;
        UpdateFreq=3;
...
//        Update(0,w);
    ...
    public function CheckPlants(world:FungiWorld)
    {
        if (OverridePos)
        {
...
class Critters
{
    ...
    public function new(world:FungiWorld,numcritters:Int)
    {
