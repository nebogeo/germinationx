...
class TruffleWorld extends truffle.World 
{
    var Frame:Int;
    var TickTime:Int;
...
/*        trace(ExternalInterface.available);
        ...
        for (i in 0...30)
        {
            AddSprite(new Sprite(new Vec2(Math.random()*300,Math.random()*300),Resources.Get("blue-cube")));
        }


        AddSprite(new Sprite(new Vec2(120,100),Resources.Get("blue-cube")));
        AddSprite(new Sprite(new Vec2(100,100),Resources.Get("blue-cube")));


        S=new Sprite(new Vec2(100,100),Resources.Get("wing"));
        AddSprite(S);
...
/*
    ...
    override function Update(time:Int)
    {
        ...
        var Pos=S.Pos;
        Pos.x=150+150*Math.sin(time*0.01);
        Pos.y=150+150*Math.cos(time*0.032);
        S.SetPos(Pos);
