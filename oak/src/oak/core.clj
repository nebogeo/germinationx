...
;(db-find-update!
; (fn [tile]
;   (println "making new avatar")
;   (merge tile {:one "hacked"})
   ;(merge tile {:entities (cons (make-avatar 999999 "poo" (make-vec2 2 2))
   ;                                             (:entities tile))})
;   )
; :test
; {:id 0})
...
(defroutes main-routes
  ...
  (GET "/move-player/:player-id/:tilex/:tiley/:posx/:posy/:iefix"
       [player-id tilex tiley posx posy iefix]
